...
test_sts_dataset_path = 'data/en_train2024_qa.json'
model_path = "sentence-transformers/output/ct-wiki-bert"
...
def return_simscore(model, examples):
    ...
    return scores, embeddings1, embeddings2
...
with open(test_sts_dataset_path, 'r') as f:
    ...
    for line in lines:
        ...
        break
test_result, emb_src, emb_tgt = return_simscore(model, test_samples)
print(test_result)
# print(type(emb_src), emb_src[0].shape, emb_src[0])
