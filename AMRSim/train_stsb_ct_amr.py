...
model_save_path = 'output/ct-amr-bert-finetuned'
################# Train sentences #################
# We use 1 Million sentences from Wikipedia to train our model
# wikipedia_dataset_path = '../data/wiki_train_data.json'
# load finetune train dataset of JCivilCode
wikipedia_dataset_path = '../data/spring/jcivilcode_ft_train2.json'
    ...
    for line in tqdm(lines[:31]):
        ...
        if add_graph:
            ...
            if edge_index[0] is None:
                continue
            inp_example = InputExample(texts=[line['graph_ref1']['amr_simple'], line['graph_ref1']['amr_simple']],
                                       edge_index=edge_index[0], edge_type=edge_type[0], pos_ids=pos_ids[0])
...
dev_sts_dataset_path = '../data/spring/jcivilcode_ft_dev.json'
dev_samples = []
...
test_sts_dataset_path = '../data/spring/jcivilcode_ft_test.json'
test_samples = []
